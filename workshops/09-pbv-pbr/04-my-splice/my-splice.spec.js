describe("mySplice", () => {
  ...
  xit("mutates the original array by removing the correct element(s) from it", () => {
  ...
  xit("removes multiple elements if deleteCount is greater than 1", () => {
  ...
  xit("returns an array of the removed elements", () => {
    let returnedValue = mySplice(["food", "trash", "clothes"], 1, 1);
    expect(returnedValue).toEqual(["trash"]);
  });

  xit("returns an array of all removed elements if deleteCount is greater than 1", () => {
    let returnedValue = mySplice([10, 20, 30, 40, 50, 60], 2, 3);
    expect(returnedValue).toEqual([30, 40, 50]);
  });

  xit("adds a new value at the correct index", () => {
    let ourStuff = ["food", "trash", "clothes"];
  ...
  xit("adds a new value at the correct index without removing an element if deleteCount is 0", () => {
    let ourStuff = ["food", "trash", "clothes"];
